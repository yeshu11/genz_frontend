...
const ResumeTechwise = () => {
  ...
  return (
    <div className="p-8 text-black">
      <h1 className={`text-3xl font-bold text-center mb-6 ${darkMode ? "text-white" : "text-black"}`}>Resume Techwise</h1>
              ...
              <table className="w-full border-collapse border shadow-lg text-lg">
                ...
                <tbody>
                  {jobResumes[selectedJob]?.length > 0 ? (
                    ...
                    <tr>
                      <td className="border p-4 text-center font-semibold" colSpan="4">No resumes found</td>
                    </tr>
                  )}
                </tbody>
              </table>
