...
const DeletedJobs = () => {
  ...
  const fetchDeletedJobs = async () => {
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/admin_super/deleted_jobs`, {
        credentials: "include",
      });
  ...
  const deleteJob = async (jobId) => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/admin_super/deleted_jobs/${jobId}`, {
        method: "DELETE",
        credentials: "include",
      });
  ...
  const restoreJob = async (jobId) => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/deleted_jobs/${jobId}/restore`, {
        method: "POST",
        credentials: "include",
      });
